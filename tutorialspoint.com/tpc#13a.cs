// tpc#13a.cs: Metod tanýmý ve iki tamsayýdan büyüðünün tespiti örneði.
...
namespace Metodlar {
    class BüyüðünTespiti {
        ...
        static void Main (string[] args) {
            ...
            Console.Write ("\n\n3 çeþit parametre aktarýmý vardýr:\n1) Deðer aktarýmý; parametrelerdeki metod içi deðiþimler argümanlarý etkilemez.\n2) Referans aktarýmý; deðiþen parametre deðerleri hafýza adresiyle argümanlara da yansýr.\n3) Çýktý aktarýmý; metodun çoklu deðer döndürümüne olanak saðlar.\nTuþ...");
            Console.ReadKey();
